...
#import "GMOGameSDKCallback.h"
#import "GMOSDKConst.h"
@class UIApplication;
@interface GMOGameSDK : NSObject

/**
 *  Singleton method return GMOGameDK instance
 *  GMOGameSDK instance will be used during application lifecycle
 *  @return GMOGameSDK object
 */
 ...
 */
@property (nonatomic, weak) id<GMOGameSDKCallback> delegate;
...
/**
 *  Function to configure GMOGameSDK when application start
 ...
 *  get User Infor
 *
 *  @return GMOUserLoginResult object
 */
+ (GMOUserLoginResult *) getUserInfo;
